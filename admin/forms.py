...
class MultipassRegistrationForm(SyncedInputsMixin, IndicoForm):
    ...
    affiliation = StringField(_('Affiliation'), [DataRequired()], widget=SyncedInputWidget())
    ...
    comment = TextAreaField(_('Comment'), [DataRequired(),  Length(min=20) ], description=_("Please provide additional information (e.g. a reson why you need this account) for the "
